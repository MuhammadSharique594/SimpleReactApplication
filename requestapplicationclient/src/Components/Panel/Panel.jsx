...
import RequestApplicationList from '../Applications/RequestApplicationList/RequestApplicationList'

// import other pkgs
import { UserEdit, Lock, ProfileCircle, Code1, Send2 } from "iconsax-react";
    ...
    constructor(props) {
        ...
        this.sidebarLinks = [
            ...
            },
            {
                id: 3,
                border: true,
                text: 'Request Applications',
                icon: <Send2 size="20" color="black" />,
                active: false,
                isvisible: true,
            },
            {
            ...
            <div className={`${styles['panel-wrapper']} d-flex align-items-center justify-content-center`}>
                ...
                <div className={`${styles.container} d-flex justify-content-center align-items-center p-0`}>
                    <Row className={`${styles['panel']} flex-column flex-md-row justify-content-center align-items-center px-3`}>
                        ...
                        <Col xs={12} sm={8} md={7} className={`${styles['panel-column']} bg-white border mt-5 mt-md-0 ms-md-5 p-5`} Style="min-height: 400px; max-height: 800px;">
                            ...
                            {this.state.toggle === 'request applications' && (
                               <RequestApplicationList
                                    sidebarLinks={this.sidebarLinks}
                                    onChangeToggle={this.changeToggle}
                               />
                            )}
                            {this.state.toggle === 'request application form' && (
                               <RequestApplication
                                    sidebarLinks={this.sidebarLinks}
                                    onChangeToggle={this.changeToggle}
                                    onChangeInfo={this.changeUserInformation} 
